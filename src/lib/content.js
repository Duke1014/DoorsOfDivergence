export const uiContent = {
    //‑ non-breaking hyphen
    nodes: {
        one: { title: 'Welcome to Paradox' },
        two: { title: 'An Invitation' },
        three: { title: 'Stubborn' },
        four: { title: 'Sins of the Father' },
        five: { title: 'Beyond the Veil' },
        six: { title: 'To the Nines' },
        seven: { title: 'Out of Time' },
        eight: { title: 'Pandora\'s Box' },
        nine: { title: 'Beyond the Veil' },
        ten: { title: 'Alchemist' },
        eleven: { title: 'What Was Lost' },
        twelve: { title: 'Machine of Blood' },
        thirteen: { title: 'Chains That Bind' },
        fourteen: { title: 'Mors Ex Machina' },
        fifteen: { title: 'Unbound' },
        sixteen: { title: 'Theurgist' },
        seventeen: { title: 'Oracle' },
    ...
    general: {
        not_unlocked: 'You haven\'t unlocked \nthis part of the story yet.',
        swipe: 'Swipe around to navigate.',
        scroll: 'Scroll around to navigate.'
    }
