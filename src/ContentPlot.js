        ...
        case 'TheurgistII':
            nodeContent = (
                <div>
                    ...
                    <p className="max-w-sm mt-2 ml-auto italic text-right">
                        - Harriet Crowley, excerpt from a letter to her unnamed protégé, 1879.
                    </p>
                    <p>
                        It is common for children of Order members to be groomed for their admission into the Three Keys, but even for those born into privilege, membership must still be earned- nothing is guaranteed. The woman who would become Proctor Andromeda grew up in the lap of luxury, born into high society and a family with a long history with the Order. It was clear to her that her father had plans for her, plans she chafed at, which resulted in brash and reckless behavior- she was kicked out of two different boarding schools, one for the formation of an illicit gambling ring among the students (and some of the faculty), and the other for creating an underground dueling club on school grounds. She was taken out of school and put under the care of a cadre of tutors handpicked by her father. It wasn’t until she  began taking lessons from a member of the Order named Harriet Crowley who recognized the girl's talents and inquisitiveness and took her off the path her father had placed her on, instead recommending her for induction into the ranks of the Proctors.
                    </p>
                </div>
            )
        break;
